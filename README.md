...
- [naming-idea-plugin: 中文程序员的变量命名工具，借用大模型的能力，快速生成符合规范的命名。](https://gitee.com/i_can_shock/naming-idea-plugin#https://gitee.com/link?target=https%3A%2F%2Fwww.icanshock.fun%2F) 
### December 29, 2025 
...
- [goforj/collection: 一个流畅的、受 Laravel 启发的集合库，用于链接、高阶函数和富有表现力的数据操作。](https://github.com/goforj/collection) 
- [savinmikhail/AddNamedArgumentsRector: AddNamedArgumentsRector 规则通过将函数、方法或构造函数调用转换为可能使用命名参数来增强您的代码。命名参数通过明确指定传递的参数名称来提高可读性并减少错误。Plugin to rector, that adds named arguments to your codebase](https://github.com/savinmikhail/AddNamedArgumentsRector) 
### December 26, 2025 
...
- [paramientos/laravel-plugin-system: 一个广泛的 Laravel 插件系统，为模块化应用程序开发提供路线、控制器、服务、视图和配置的自动注册。](https://github.com/paramientos/laravel-plugin-system) 
### December 24, 2025 
...
- [laravel/ranger: Ranger 是 Laravel 应用程序的强大自检库。](https://github.com/laravel/ranger) 
- [MrPunyapal/rector-pest: PestPHP 的 Rector 规则可提高代码质量并帮助版本升级。](https://github.com/MrPunyapal/rector-pest) 
### December 23, 2025 
...
- [sunchayn/nimbus: Nimbus 自动分析您的路由和验证规则，以构建交互式请求模式和用于测试和探索 API 的本机接口。](https://github.com/sunchayn/nimbus) 
### December 22, 2025 
...
- [skim-rs/skim: 我们平时花很多时间去文件、行和命令之间切换来切换去。这时候 Skim 就派上用场了！它是一个强大的模糊查找工具，能帮你让工作流程更快更高效。](https://github.com/skim-rs/skim) 
### December 17, 2025 
...
- [nekofar/php-dev-tools: PHP 项目的一些有用的开发要求。](https://github.com/nekofar/php-dev-tools) 
### December 10, 2025 
...
- [CaoMeiYouRen/push-all-in-one: 支持 Server 酱 (以及 Server 酱 ³)、自定义邮件、钉钉机器人、企业微信机器人、企业微信应用、飞书、pushplus、WxPusher、iGot、Qmsg、息知、PushDeer、Discord、OneBot、Telegram、ntfy 等多种推送方式。](https://github.com/CaoMeiYouRen/push-all-in-one) 
### December 8, 2025 
...
- [antonmedv/gitmal: Gitmal 是一个用于 Git 仓库的静态页面生成器。Gitmal 可以使用文件、提交、代码高亮和 Markdown 渲染生成静态 HTML 页面。](https://github.com/antonmedv/gitmal) 
### November 30, 2025 
...
- [logancyang/obsidian-copilot: Obsidian 的 Copilot 是您保险库中的 AI 助手，具有基于聊天的保险库搜索、网页和 YouTube 支持、强大的上下文处理能力，以及在 Obsidian 高度可定制的工作区内不断扩展的自主能力 - 同时确保您的数据掌握在您手中。](https://github.com/logancyang/obsidian-copilot) 
- [ash-jc-allen/email-utilities: 可用于与电子邮件地址交互的小型 Laravel 包](https://github.com/ash-jc-allen/email-utilities) 
- [houdaslassi/vantage: 一个跟踪和监控您的队列作业的 Laravel 包。自动记录作业执行历史、失败、重试，并提供一个简单的网页界面以查看所有内容。](https://github.com/houdaslassi/vantage) 
- [tarunkorat/laravel-asset-cleaner: 从 Laravel 应用程序中安全地检测和删除未使用的 CSS、JS、SCSS 和其他资产](https://github.com/tarunkorat/laravel-asset-cleaner) 
### November 18, 2025 
...
- [JustSteveKing/mit: 实现 PSR-14 的轻量级、类型安全的事件发射器。](https://github.com/JustSteveKing/mit) 
### November 17, 2025 
...
- [SSHGuard/sshguard: 保护主机免受针对 SSH 和其他服务的暴力攻击](https://github.com/SSHGuard/sshguard) 
- [samber/ro: Go 的反应式编程范例：用于事件驱动应用程序的声明式和可组合 API](https://github.com/samber/ro) 
### November 8, 2025 
...
- [theofidry/AliceDataFixtures: Nelmio Alice 扩展，用于持久化加载的 fixture。](https://github.com/theofidry/AliceDataFixtures) 
### November 7, 2025 
...
- [azjezz/php-syntax-analyzer: 分析 PHP 包以评估在 PHP 中保留关键字的影响。](https://github.com/azjezz/php-syntax-analyzer) 
### November 4, 2025 
...
- [tarunkorat/laravel-migration-squasher: 将旧的 Laravel 迁移压缩到单个模式文件中](https://github.com/tarunkorat/laravel-migration-squasher) 
### November 2, 2025 
...
- [Lakr233/FlowDown: 浮望 (FlowDown) 是一款为 Apple 平台精心打造的原生 AI 对话客户端，追求极致的速度与流畅体验，并始终将你的隐私放在首位。无论是在 iPhone、iPad 还是 Mac 上，浮望都能为你提供与 AI 模型交互的绝佳体验。](https://github.com/Lakr233/FlowDown) 
### October 30, 2025 
...
- [webreinvent/vaahcms: VAAHCMS 是一个基于 Laravel 的开源 Web 应用程序开发平台，附带一个无头内容管理系统 (CMS)。](https://github.com/webreinvent/vaahcms) 
### October 27, 2025 
...
- [rhukster/sphp.sh: 用于在 BREW 安装的 PHP 版本之间切换的 Shell 脚本](https://github.com/rhukster/sphp.sh) 
### October 24, 2025 
...
- [TheDragonCode/laravel-telemetry: 服务间通信的端到端遥测。](https://github.com/TheDragonCode/laravel-telemetry) 
- [dinoDanic/diny: 为你编写 git 提交信息。它查看你的暂存更改并生成清晰、符合规范的消息。](https://github.com/dinoDanic/diny) 
### October 19, 2025 
...
- [HMYDK/AIGitCommit: 此插件使用 AI 根据代码中的更改自动生成提交消息。](https://github.com/HMYDK/AIGitCommit) 
### October 18, 2025 
...
- [Lakr233/Asspp: 轻松管理多个 App Store 账户。](https://github.com/Lakr233/Asspp) 
### October 16, 2025 
...
- [illuminate/json-schema: Illuminate Json Schema 软件包。](https://github.com/illuminate/json-schema) 
### October 14, 2025 
...
- [code3-dev/DNS-XS: 测试和比较各种 DNS 服务器的性能](https://github.com/code3-dev/DNS-XS) 
### October 12, 2025 
...
- [timelinize/timelinize: 在您的计算机上将所有帐户和设备的数据存储在一个统一的时间线上](https://github.com/timelinize/timelinize) 
### October 6, 2025 
...
- [surfbryce/beautiful-lyrics: 通过引入实时歌词、动态背景和沉浸式视图，彻底改变了 Spotify 歌词体验](https://github.com/surfbryce/beautiful-lyrics) 
- [rxri/spicetify-extensions: 收集自定义 Spicetify 扩展以增强您的 Spotify 体验](https://github.com/rxri/spicetify-extensions) 
### September 19, 2025 
...
- [jaywcjlove/vidcrop: VidCrop 是一款视频裁剪工具，可帮助您轻松裁剪视频文件。](https://github.com/jaywcjlove/vidcrop) 
### September 16, 2025 
...
- [riddleling/iOS-OCR-Server:IOS OCR 服务器，使用 Apple 的 Vision Framework API。](https://github.com/riddleling/iOS-OCR-Server) 
### September 12, 2025 
...
- [slowestwind/tab-session-guard: TabGuard 是一个 Laravel 包，帮助您控制和限制用户可以打开多少个标签页、会话或模块窗口 (如个人资料、仪表板)。它确保了专注的工作流程，减少了服务器负载，防止滥用 (如通过隐身窗口绕过限制)，并提供了灵活的配置系统以微调会话限制。](https://github.com/slowestwind/tab-session-guard) 
### September 11, 2025 
...
- [ven-coder/Assists: 🔥Android 无障碍服务 (AccessibilityService) 开发框架，Android 自动化脚本框架，快速开发复杂自动化任务、远程协助、监听等](https://github.com/ven-coder/Assists) 
- [overtrue/laravel-text-guard: 一个用于 Laravel 的强大字符串清理和规范化工具，可用于验证规则或独立使用。](https://github.com/overtrue/laravel-text-guard) 
- [Adembc/lazyssh: 一个基于终端的 SSH 管理器，灵感来自 lazydocker 和 k9s - 用 Go 编写](https://github.com/Adembc/lazyssh) 
### September 2, 2025 
...
- [yii2-extensions/franken-php: 为 Yii2 应用程序提供的极速 FrankenPHP 集成，支持无缝的 HTTP/2 和 HTTP/3，自动内存管理，以及实时功能。](https://github.com/yii2-extensions/franken-php) 
### September 1, 2025 
...
- [dudor/BookmarkHub: BookmarkHub 是一款浏览器插件，可以在不同浏览器之间同步你的书签。](https://github.com/dudor/BookmarkHub) 
- [speauty/anto: 字幕文件 (srt) 翻译工具，Windows 专用](https://github.com/speauty/anto) 
### August 30, 2025 
...
- [quarylabs/sqruff: sqruff 是一个用 Rust 编写的 SQL 代码检查和格式化工具。](https://github.com/quarylabs/sqruff) 
- [eythaann/Seelen-UI: 适用于 Windows 10/11 的完全可定制的桌面环境。](https://github.com/eythaann/Seelen-UI) 
### August 27, 2025 
...
- [nemofq/pushbullet-go: 一个轻量级的 Pushbullet 扩展，支持直接从浏览器接收和发送推送消息。](https://github.com/nemofq/pushbullet-go) 
### August 10, 2025 
...
- [sst/models.dev: AI 模型的开源数据库。](https://github.com/sst/models.dev) 
### August 7, 2025 
...
- [goplus/llgo: goplus/llgo: 基于 LLVM 的 GO 编译器，以便更好地整合到包括 Python 和 JavaScript 在内的 C 生态系统](https://github.com/goplus/llgo) 
### August 1, 2025 
...
- [okooo5km/HiPixel: HiPixel 是一款原生 MacOS 应用程序，用于 AI 驱动的图像超分辨率，使用 SwiftUI 构建，并利用 Upscayl 强大的 AI 模型。](https://github.com/okooo5km/HiPixel) 
### July 27, 2025 
...
- [aaPanel/BillionMail: BillionMail 为您提供开源的邮件服务器、新闻通讯、电子邮件营销](https://github.com/aaPanel/BillionMail) 
- [Conxt/WindowGlue: 一个简单的 macOS 菜单栏工具，可以将两个窗口粘合在一起，使它们 (大部分情况下) 像一个窗口一样运行。](https://github.com/Conxt/WindowGlue) 
### July 24, 2025 
...
- [sqlfluff/sqlfluff: 一个模块化的 SQL 语法检查器和自动格式化工具，支持多种方言和模板化代码。](https://github.com/sqlfluff/sqlfluff) 
### July 23, 2025 
...
- [PHP 中的 "never" 类型](https://ashallendesign.co.uk/blog/php-never-type) 
### July 2, 2025 
...
- [ace-of-aces/laravel-image-transform-url: 简单的基于 URL 的图像转换，灵感来自 Cloudflare Images。](https://github.com/ace-of-aces/laravel-image-transform-url) 
- [anycable/anycable-laravel: AnyCable 广播适配器用于 Laravel](https://github.com/anycable/anycable-laravel) 
### June 20, 2025 
...
- [XcodesOrg/XcodesApp: 通过鼠标点击，最简单的方式安装和切换多个版本的 Xcode。](https://github.com/XcodesOrg/XcodesApp) 
### June 12, 2025 
...
- [algoyounes/laravel-idempotency: 🛡️ 用于防止重复请求的 Laravel Idempotency 中间件包](https://github.com/algoyounes/laravel-idempotency) 
- [greenlion/PHP-SQL-Parser: 一个专门用于解析 MySQL SQL 语句的纯 PHP 解析器，不进行语法验证。](https://github.com/greenlion/PHP-SQL-Parser) 
### June 11, 2025 
...
- [fdomgjoni99/laravel-ai-factory: Laravel AI Factory 是一个开发者友好的包，用于使用 AI 模型生成逼真的测试数据。它与 Laravel 工厂无缝集成，并支持 AI 生成和手动定义的字段，可以选择批量或单个插入。](https://github.com/fdomgjoni99/laravel-ai-factory) 
### May 30, 2025 
...
- [git-bug/git-bug: 分布式、离线优先的嵌入在 Git 中的错误跟踪器](https://github.com/git-bug/git-bug) 
- [taubyte/tau: 开源的分布式平台即服务 (PaaS)。一个自托管的 Vercel / Netlify / Cloudflare 替代方案。](https://github.com/taubyte/tau) 
- [JefferyHcool/BiliNote: AI 视频笔记生成工具让 AI 为你的视频做笔记](https://github.com/JefferyHcool/BiliNote) 
- [ultrazg/xyz: 小宇宙 FM API](https://github.com/ultrazg/xyz) 
- [ultrazg/xyz: 小宇宙 FM API](https://github.com/ultrazg/xyz) 
### May 16, 2025 
...
- [symfony-tools/carsonbot: Carson 是目前运行在 symfony/symfony 仓库上的一个机器人。它的工作是帮助自动执行不同的问题和拉取请求工作流程。](https://github.com/symfony-tools/carsonbot) 
### May 12, 2025 
...
- [rectorphp/jack: Jack 可帮助您逐步更新依赖项，确保您的项目保持最新状态，而不会出现过时包的混乱。](https://github.com/rectorphp/jack) 
### April 19, 2025 
...
- [antfu/userscript-open-in-codeflow: 添加一个按钮以在 GitHub 的 Codeflow 中打开 repo/issue/PR](https://github.com/antfu/userscript-open-in-codeflow) 
### April 5, 2025 
...
- [justbetter/laravel-unique-values: 生成支持并发的唯一值](https://github.com/justbetter/laravel-unique-values) 
### March 21, 2025 
...
- [phpacker/phpacker: 将任何 PHP 脚本或 PHAR 打包到独立的跨平台可执行文件中](https://github.com/phpacker/phpacker) 
- [Intervention/zodiac: PHP 星座计算器](https://github.com/Intervention/zodiac) 
### March 19, 2025 
...
- [huacnlee/autocorrect: 一个 linter 和格式化程序，可帮助您改进文案写作，更正 CJK (中文、日语、韩语) 之间的空格、单词和标点符号。](https://github.com/huacnlee/autocorrect) 
### March 15, 2025 
...
- [x-falcon/Virtual-Hosts: 安卓主机，通过 vpn 模式实施，支持通配符 DNS 记录](https://github.com/x-falcon/Virtual-Hosts) 
### March 11, 2025 
...
- [TheDragonCode/size-sorter: 轻松排序衣服尺寸、身高、胸罩尺寸、家具尺寸等](https://github.com/TheDragonCode/size-sorter) 
- [cesargb/laravel-cascade-delete: 实现多态关系的 Eloquent 模型的级联删除](https://github.com/cesargb/laravel-cascade-delete) 
- [milon/barcode: Laravel 条形码生成器](https://github.com/milon/barcode) 
...
- [ergebnis/classy: 🔍 提供一个 composer 包，其中包含用于经典结构 (类、枚举、接口和特征) 的查找器。](https://github.com/ergebnis/classy) 
### February 23, 2025 
- [alekitto/class-finder: 帮助发现其他类/命名空间的实用程序类](https://github.com/alekitto/class-finder) 
### February 21, 2025 
...
- [web-dahuyou/NiceTab: 浏览器插件：方便快捷的浏览器标签页管理插件，OneTab 的升级替代品](https://github.com/web-dahuyou/NiceTab) 
### February 20, 2025 
...
- [CherryHQ/cherry-studio: 🍒 Cherry Studio 是一个桌面客户端，支持多个 LLM 提供程序。](https://github.com/CherryHQ/cherry-studio) 
### February 12, 2025 
